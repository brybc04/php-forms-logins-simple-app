...
<body>
    ...
    <div>
        ...
        <!-- STARTING POINT  --> 
  <form action="selectStudent1.php" method="GET" style="margin-top: 70px; margin-left:150pt;">
     <p class="h4"> Search All by Keyword </p><br>

      Keyword: <input type="text" name="firstName" class="form-control" style="width: 20%"; ><br>
      Last Name: <input type="hidden" name="lastName" class="form-control" style="width: 20%;"  ><br>

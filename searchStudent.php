...
<div class="container" >
  <div class="row">
    <div class="col form-group" style="margin-top: 70px; ">

        <!-- FORM SEARCH STUDENT BY FNAME AND LNAME -->
      <form action="selectStudent1.php" method="GET" style="text-align: left"">
        <p class="h4"> Search by Name </p><br>
        First Name: <input type="text" name="firstName" class="form-control" style="width: 40%; placeholder="required" required><br>
        Last Name: <input type="text" name="lastName" class="form-control" style="width: 40%;"  required><br>
        <input type="submit" value="Search" class="btn btn-warning">
      </form>
    </div>

        <!-- FORM SEARCHING FOR ANYTHING FROM DB -->
    <div class="col form-group" style="margin-top: 70px; ">
      <form action="selectStudent1.php" method="GET" style="text-align: left"">
        <p class="h4"> Search All </p><br>
        Keyword <input type="text" name="firstName" class="form-control" style="width: 50%; placeholder="required" ><br>
        <input type="hidden" name="lastName" class="form-control" style="width: 20%;"  required>
        <input type="submit" value="Feeling Lucky!" class="btn btn-warning">
      </form>
  </div>
</div>

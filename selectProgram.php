...
<body>
    ...
    <table class="table table-striped h6" >
            <p class="h5 text-center ">Program Information </p>
        ...
        <?php 	
            ...
            // request
            $query = "SELECT program_id, program_name, program_length, program_description FROM program";
                $result = mysqli_query($cox, $query);
            
            //from db print colums
            while($row = mysqli_fetch_array($result)){
                ...
                echo "<td><a href='updateProgram.php?id=$row[0]'>Update</a> ";
                echo "<a href='deleteProgram.php?id=$row[0]'>Delete</a> </td>";
                echo "</tr>"; 
            }
            //manual closing
            mysqli_close($cox);	
